import numpy as np
a1 = [1,2,3,4,5,6,7]
a1          #O/P:- [1, 2, 3, 4, 5, 6, 7]


arr1 = np.array([1,2,3,4,5,6,7])
arr1        #O/P:- array([1, 2, 3, 4, 5, 6, 7])


# array supports elementwise operation
print(type(arr1))       # O/P:- <class 'numpy.ndarray'>
...
print(arr1.size) #total number of elements inside the array     #O/P:- 7


arr2 = np.array(['A', 'B', 'C', 'D', 'E', 'F'])
arr2    # O/P:- array(['A', 'B', 'C', 'D', 'E', 'F'], dtype='<U1')
...
list(range(1,10)) #last ement is not included       #[1, 2, 3, 4, 5, 6, 7, 8, 9]
